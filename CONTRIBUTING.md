...
> This page copied from github.com/homebrew/homebrew-cask/CONTRIBUTING.md
...
Notice an application that's out-of-date in Homebrew Cask? In most cases, it's very simple to update it. 
