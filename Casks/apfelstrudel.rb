cask "apfelstrudel" do
  ...
  zap trash: [
    "~/Library/Caches/co.eclecticlight.Apfelstrudel",
    "~/Library/Preferences/co.eclecticlight.Apfelstrudel.plist",
    "~/Library/Saved Application State/co.eclecticlight.Apfelstrudel.savedState",
  ]
end
